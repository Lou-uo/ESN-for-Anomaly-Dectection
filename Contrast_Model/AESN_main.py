...
# 导入AESN核心实现
from AESN_model import AdaptiveESN, AdaptiveESNAnomalyDetector
...
def main():
    ...
    print(f"🚀 自适应ESN(AESN)异常检测模型训练器 | 使用设备：{global_config['device']}")
    print(f"⚙️  AESN基础配置：hidden_dim={global_config['hidden_dim']}")
